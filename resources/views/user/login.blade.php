...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/login_form/form-1/assets/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="/login_form/choose-layout-assets/style.css">
	            	...
	            	<div class="col-sm-10 col-sm-offset-1">
	            		<div class="row">
		                	<div class="col-sm-4 layout-box">
			                	<a href="/login_form/form-1/index.html">
			                		<img src="/login_form/choose-layout-assets/1.jpg" alt="">
			                	</a>
			                	<p>Form 1</p>
		                    </div>
		                    <div class="col-sm-4 layout-box">
		                    	<a href="/login_form/form-2/index.html">
				                	<img src="/login_form/choose-layout-assets/2.jpg" alt="">
			                    </a>
			                    <p>Form 2</p>
		                    </div>
		                    <div class="col-sm-4 layout-box">
			                	<a href="/login_form/form-3/index.html">
			                		<img src="/login_form/choose-layout-assets/3.jpg" alt="">
			                	</a>
			                	<p>Form 3</p>
		                    </div>
	                    </div>
